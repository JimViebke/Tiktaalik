...
namespace chess
{
	...
	color_t board::load_fen(const std::string& fen)
	{
		...
		for (char c = *fen_it++; c != ' '; c = *fen_it++)
		{
			switch (c)
			{
				case 'P': bitboards.white |= (1ull << idx); bitboards.pawns |= (1ull << idx++); break;
				case 'N': bitboards.white |= (1ull << idx); bitboards.knights |= (1ull << idx++); break;
				case 'B': bitboards.white |= (1ull << idx); bitboards.bishops |= (1ull << idx++); break;
				case 'R': bitboards.white |= (1ull << idx); bitboards.rooks |= (1ull << idx++); break;
				case 'Q': bitboards.white |= (1ull << idx); bitboards.queens |= (1ull << idx++); break;
				case 'K': bitboards.white |= (1ull << idx); bitboards.kings |= (1ull << idx++); break;
				case 'p': bitboards.black |= (1ull << idx); bitboards.pawns |= (1ull << idx++); break;
				case 'n': bitboards.black |= (1ull << idx); bitboards.knights |= (1ull << idx++); break;
				case 'b': bitboards.black |= (1ull << idx); bitboards.bishops |= (1ull << idx++); break;
				case 'r': bitboards.black |= (1ull << idx); bitboards.rooks |= (1ull << idx++); break;
				case 'q': bitboards.black |= (1ull << idx); bitboards.queens |= (1ull << idx++); break;
				case 'k': bitboards.black |= (1ull << idx); bitboards.kings |= (1ull << idx++); break;
	...
	void board::generate_key_and_eval(const color_t color_to_move)
	{
		...
		auto hash_and_eval_color = [=, this](const color_t color,
