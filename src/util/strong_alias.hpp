...
namespace util
{
	...
	public:
		...
		template <typename other_t>
		    requires std::is_arithmetic<other_t>::value
		constexpr bool operator<(const other_t& rhs) const
		{
			return value() < T(rhs);
		}
		template <typename other_t>
		...
		template <typename other_t>
		    requires std::is_arithmetic<other_t>::value
		constexpr strong_alias operator+(const other_t& rhs) const
		{
			return value() + rhs;
		}
		template <typename other_t>
		...
		template <typename other_t>
		    requires std::is_arithmetic<other_t>::value
		constexpr strong_alias& operator+=(const other_t& rhs)
		{
			value() += rhs;
			return *this;
		}
		...
		constexpr strong_alias& operator&=(const strong_alias& rhs)
		{
			value() &= rhs.value();
			return *this;
		}
		...
		constexpr strong_alias& operator&=(const auto& rhs)
		{
			value() &= rhs;
			return *this;
		}
	...
	constexpr static bool operator>(const other& lhs, const strong_alias<T, tag>& rhs)
	{
		return lhs > rhs.value();
	}

	template <typename other, typename T, typename tag>
	constexpr static other operator+(const other& lhs, const strong_alias<T, tag>& rhs)
	{
		return lhs + rhs.value();
	}
	template <typename other, typename T, typename tag>
	...
	template <typename other, typename T, typename tag>
	constexpr static other& operator+=(other& lhs, const strong_alias<T, tag>& rhs)
	{
		lhs += rhs.value();
		return lhs;
	}
	...
	template <typename T, typename tag>
	constexpr static strong_alias<T, tag> operator&(const auto& lhs, const strong_alias<T, tag>& rhs)
	{
		return lhs & rhs.value();
	}
	template <typename T, typename tag>
